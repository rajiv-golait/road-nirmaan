...
final List<Map<String, dynamic>> allComplaints = [
  ...
  {
    'title': 'Large Crack on Highway',
    'location': 'Pune Highway, Solapur',
    'coords': LatLng(17.6850, 75.8850),
    'severity': 'High',
    'status': 'Pending',
    'id': 'CMP202604',
    'date': '2026-01-25',
    'images': ['assets/download (3).jpg', 'assets/images (2).jpg'],
  },
  {
    'title': 'Sunken Pavement Segment',
    'location': 'Bhavani Peth, Solapur',
    'coords': LatLng(17.6750, 75.9250),
    'severity': 'Medium',
    'status': 'Under Review',
    'id': 'CMP202605',
    'date': '2026-01-24',
  ...
  {
    'title': 'Eroded Road Shoulder',
    'location': 'Vidi Gharkul, Solapur',
    'coords': LatLng(17.6450, 75.9350),
    'severity': 'Low',
    'status': 'Resolved',
    'id': 'CMP202606',
    'date': '2026-01-23',
  ...
  },
  {
    ...
    'location': 'Chhatrapati Shivaji Chowk',
    'coords': LatLng(17.6680, 75.9080),
    'severity': 'High',
    'status': 'Pending',
    'id': 'CMP202607',
    'date': '2026-01-22',
  ...
  {
    'title': 'Waterlogged Road Damage',
    'location': 'Near Solapur Station',
    'coords': LatLng(17.6620, 75.9020),
    'severity': 'Medium',
    'status': 'Under Review',
    'id': 'CMP202608',
    'date': '2026-01-21',
    'images': ['assets/download (3).jpg', 'assets/images (4).jpg'],
  },
  {
  ...
  {
    'title': 'Loose Gravel Hazard',
    'location': 'Akkalkot Road',
    'coords': LatLng(17.6500, 75.9450),
    'severity': 'Low',
    'status': 'Resolved',
    'id': 'CMP202610',
    'date': '2026-01-19',
    'images': ['assets/download (2).jpg', 'assets/images (3).jpg'],
  },
];
          ...
          Padding(
            ...
            child: Center(
              child: TextButton.icon(
                onPressed: () {
                  setState(() {
                    _displayCount = (_displayCount + 2).clamp(
                      0,
                      _totalAvailable,
                    );
                  });
...
class _TrackView extends StatelessWidget {
  ...
  static final List<Map<String, dynamic>> myComplaints = [
    {
      'id': 'CMP202601',
      ...
      'upvotes': 12,
      'hasUpvoted': true,
      'verificationRemarks': ['Engineer Confirmed', 'Field Verified'],
      'officialRemarks': 'Repair work scheduled for 3rd Feb. Crew assigned.',
      'images': [
      ...
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '29 Jan 2026, 10:42 AM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
          'date': '29 Jan 2026, 2:15 PM',
        },
        {
    ...
    },
    {
      ...
      'submittedDate': '28 Jan 2026, 3:20 PM',
      'lastUpdated': '3 days ago',
      'isMine': true,
      'upvotes': 5,
      'hasUpvoted': false,
      'verificationRemarks': ['Under Review'],
      'officialRemarks': 'Inspection pending. Will be assessed by 5th Feb.',
      'images': ['assets/download (4).jpg', 'assets/download (5).jpg'],
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '28 Jan 2026, 3:20 PM',
        },
        {
          'stage': 'Under Review',
          'completed': false,
  ...
  // Dummy data for Other Complaints
  static final List<Map<String, dynamic>> otherComplaints = [
    {
      'id': 'CMP202602',
      'title': 'Large crack near Railway Station',
      'location': 'Railway Station Road, Solapur',
      'coords': LatLng(17.6650, 75.9050),
      'status': 'Pending',
      'submittedDate': '27 Jan 2026, 9:15 AM',
      'lastUpdated': '4 days ago',
      'isMine': false,
      'upvotes': 8,
      'hasUpvoted': false,
      'verificationRemarks': ['Engineer Confirmed', 'Pending Approval'],
      'officialRemarks':
          'Awaiting budget approval from Municipal Standing Committee.',
      'images': ['assets/download (6).jpg', 'assets/download (1).jpg'],
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '27 Jan 2026, 9:15 AM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
          'date': '27 Jan 2026, 11:30 AM',
        },
        {
          'stage': 'Pending Approval',
          'completed': false,
    ...
    {
      'id': 'CMP202603',
      'title': 'Flooded road section',
      'location': 'Hotgi Road, Solapur',
      'coords': LatLng(17.6550, 75.9150),
      'status': 'Resolved',
      'submittedDate': '20 Jan 2026, 8:00 AM',
      'lastUpdated': '1 week ago',
      'isMine': false,
      'upvotes': 25,
      'hasUpvoted': true,
      'verificationRemarks': ['Field Verified', 'Work Completed'],
      'officialRemarks':
          'Drainage work completed. Road cleared and operational.',
      'images': ['assets/download (1).jpg', 'assets/download (3).jpg'],
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '20 Jan 2026, 8:00 AM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
      ...
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '26 Jan 2026, 11:30 AM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
          'date': '26 Jan 2026, 2:00 PM',
        },
        {
          'stage': 'Pending Approval',
          'completed': true,
...
class _MapViewState extends State<_MapView> {
  ...
  final List<Map<String, dynamic>> _complaintLocations = [
    {
      'id': 'CMP202601',
      'title': 'Pothole on MG Road',
      ...
      'submittedDate': '25 Jan 2026, 10:42 AM',
      ...
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '25 Jan 2026, 10:42 AM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
          'date': '26 Jan 2026, 02:15 PM',
        },
        {
      ...
      'verificationRemarks': ['Engineer Confirmed', 'Crew Dispatched'],
    },
    {
      'id': 'CMP202602',
      'title': 'Large crack near Railway Station',
      'location': LatLng(17.6650, 75.9050),
      'status': 'Pending Approval',
      'color': Colors.orange,
      'isMine': false,
      'address': 'Railway Station Area, Solapur',
      'submittedDate': '28 Jan 2026, 09:15 AM',
      ...
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '28 Jan 2026, 09:15 AM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
          'date': '28 Jan 2026, 04:30 PM',
        },
        {
          'stage': 'Pending Approval',
          'completed': false,
          'current': true,
          'date': 'Awaiting Dept Head',
        },
      ],
      'verificationRemarks': ['Field Verified'],
    },
    {
      'id': 'CMP202603',
      'title': 'Damaged road sign',
      'location': LatLng(17.6550, 75.9150),
      'status': 'Resolved',
      'color': Colors.green,
      'isMine': false,
      'address': 'Navi Peth, Solapur',
      'submittedDate': '20 Jan 2026, 04:30 PM',
      'lastUpdated': '2 days ago',
      'upvotes': 25,
      'hasUpvoted': false,
      'images': ['assets/download (3).jpg', 'assets/download (1).jpg'],
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '20 Jan 2026, 04:30 PM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
        ...
        },
        {
          'stage': 'Resolved',
          'completed': true,
          'date': '27 Jan 2026, 05:00 PM',
        },
      ],
      'officialRemarks': 'Road sign replaced and secured. Site cleared.',
    },
    {
      'id': 'CMP202605',
      'title': 'Broken speed breaker',
      'location': LatLng(17.6600, 75.9000),
      'status': 'Pending',
      'color': Colors.red,
      'isMine': false,
      'address': 'Hotgi Road, Solapur',
      'submittedDate': '29 Jan 2026, 11:20 AM',
      'lastUpdated': 'Just now',
      'upvotes': 5,
      'hasUpvoted': false,
      'images': ['assets/download (1).jpg', 'assets/download (2).jpg'],
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '29 Jan 2026, 11:20 AM',
        },
        {
          'stage': 'Pending',
          'completed': false,
    ...
    },
    {
      ...
      'location': LatLng(17.6680, 75.9150),
      'status': 'Pending Approval',
      'color': Colors.orange,
      'isMine': false,
      'address': 'Solapur Bypass Road',
      'submittedDate': '27 Jan 2026, 02:45 PM',
      ...
      'timeline': [
        ...
        },
        {
          ...
          'completed': false,
          'current': true,
          'date': 'Budget Approval',
        },
      ],
      'verificationRemarks': ['Cost Estimate Ready'],
    },
    {
      'id': 'CMP202606',
      ...
      'submittedDate': '24 Jan 2026, 01:10 PM',
      ...
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '24 Jan 2026, 01:10 PM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
          'date': '25 Jan 2026, 04:00 PM',
        },
        {
          'stage': 'Inspection',
          'completed': true,
    ...
    {
      'id': 'CMP202607',
      'title': 'Pothole at Hotgi Road',
      'location': LatLng(17.6500, 75.9100),
      'status': 'Resolved',
      'color': Colors.green,
      'isMine': false,
      'address': 'Hotgi Road Extension',
      'submittedDate': '22 Jan 2026, 10:00 AM',
      'lastUpdated': '1 day ago',
      'upvotes': 56,
      'hasUpvoted': true,
      'images': [
      ...
      'timeline': [
        {
          'stage': 'Reported',
          'completed': true,
          'date': '22 Jan 2026, 10:00 AM',
        },
        {
          'stage': 'Under Review',
          'completed': true,
          'date': '23 Jan 2026, 11:00 AM',
        },
        {
          'stage': 'Resolved',
          'completed': true,
          'date': '28 Jan 2026, 04:00 PM',
        },
      ],
      'officialRemarks': 'Pothole filled with cold mix. Surface leveled.',
    },
    {
      'id': 'CMP202604',
      'title': 'Surface damage on highway',
...
class _ActivityViewState extends State<_ActivityView> {
  ...
  static const Map<String, dynamic>? pinnedUpdate = {
...
class _TotalComplaintsOverviewState extends State<_TotalComplaintsOverview> {
  ...
  Widget build(BuildContext context) {
    // Analytics data
    final totalComplaints = 45;
    final resolved = 32;
    final workInProgress = 12;
    final pendingApproval = 1;
