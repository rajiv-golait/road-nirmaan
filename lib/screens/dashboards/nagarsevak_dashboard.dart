...
class NagarsevakDashboard extends StatefulWidget {
  const NagarsevakDashboard({super.key});

  @override
  State<NagarsevakDashboard> createState() => _NagarsevakDashboardState();
}
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                Text( _userProfile?['name']?.toString() ?? 'Shri. Vilasrao Deshmukh', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: textPrimary) ),
                const SizedBox(height: 4),
          ...
          // 2️⃣ ELECTED REPRESENTATIVE SECTION
          _sectionCard(
            title: 'Elected Representative',
            icon: Icons.badge_outlined,
            children: [
              _infoRow('Position', 'Nagar Sevak (Corporator)'),
              const Divider(height: 16),
              _infoRow('Ward', 'Ward 12'),
              const Divider(height: 16),
              _infoRow('Party', 'Independent'),
            ],
          ),
          const SizedBox(height: 16),

          // 3️⃣ REPRESENTED WARD SECTION
          _sectionCard(
            title: 'Represented Ward',
            icon: Icons.location_on_outlined,
            children: [
              const Text(
                'Elected representative for this ward:',
                style: TextStyle(fontSize: 13, color: textSecondary),
              ),
              const SizedBox(height: 12),
              Container(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.location_city, color: Color(0xFF2E7D32)),
                    SizedBox(width: 12),
                    Text(
