...
class JrEngineerDashboard extends StatefulWidget {
  ...
  @override
  State<JrEngineerDashboard> createState() => _JrEngineerDashboardState();
}

class _JrEngineerDashboardState extends State<JrEngineerDashboard> {
  int _selectedIndex = 0;
  final GlobalKey<_MapViewState> _mapKey = GlobalKey<_MapViewState>();

  final List<String> _titles = [
    'Junior Engineer Home',
    'My Desk',
    'Complaint Map',
    'City Activity',
    'My Profile',
...
/// Ward filter from Supabase `profiles.ward_zone` / `user_roles.ward_zone` ([WardAssignmentService]).
class _JEConfig {
      ...
      child: Column(
        ...
        children: [
          ...
          _sectionCard(
            ...
            children: [
              _infoRow('Department', _JEConfig.department),
              const Divider(height: 16),
              _infoRow('Designation', 'Junior Engineer (Roads)'),
              const Divider(height: 16),
              _infoRow('Employee ID', _JEConfig.employeeId),
            ],
          ),
          const SizedBox(height: 16),
          ...
          _sectionCard(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: _JEConfig.assignedWards
                    .map(
                      (ward) => Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 12,
