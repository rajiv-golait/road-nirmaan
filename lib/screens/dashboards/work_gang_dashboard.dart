...
List<Map<String, dynamic>> get allComplaints =>
    LegacyDashboardAdapter.detailComplaints(
      ComplaintStore.instance.getWorkGangComplaints(),
    );
...
class WorkGangDashboard extends StatefulWidget {
  const WorkGangDashboard({super.key});

  @override
  State<WorkGangDashboard> createState() => _WorkGangDashboardState();
}

class _WorkGangDashboardState extends State<WorkGangDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: null, // No Report Damage button for Work Gang
...
class _HomeViewState extends State<_HomeView> {
  ...
  List<Map<String, dynamic>> get _dashboardComplaints => 
      LegacyDashboardAdapter.detailComplaints(ComplaintStore.instance.getWorkGangComplaints());
...
class _TrackView extends StatelessWidget {
  ...
  static List<Map<String, dynamic>> get myComplaints =>
      LegacyDashboardAdapter.detailComplaints(
        ComplaintStore.instance.getWorkGangComplaints().where(
          (c) => (c['status'] ?? '').toString() != 'Resolved',
        ),
      );
