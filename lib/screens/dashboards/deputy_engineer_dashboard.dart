...
List<Map<String, dynamic>> get allComplaints =>
    LegacyDashboardAdapter.detailComplaints(
      ComplaintStore.instance.getComplaintsForDE(_DEConfig.assignedWards),
    );
...
class DeputyEngineerDashboard extends StatefulWidget {
  const DeputyEngineerDashboard({super.key});

  @override
  State<DeputyEngineerDashboard> createState() =>
      _DeputyEngineerDashboardState();
}

class _DeputyEngineerDashboardState extends State<DeputyEngineerDashboard> {
  int _selectedIndex = 0;
  final GlobalKey<_MapViewState> _mapKey = GlobalKey<_MapViewState>();

  final List<String> _titles = [
    'Deputy Engineer Home',
    'My Desk',
    'Complaint Map',
    'City Activity',
    'My Profile',
...
class _HomeViewState extends State<_HomeView> {
  ...
  List<Map<String, dynamic>> get _dashboardComplaints => 
      LegacyDashboardAdapter.detailComplaints(ComplaintStore.instance.getComplaintsForDE(_DEConfig.assignedWards));
...
// Deputy Engineer Assigned Wards (Mock data)
class _DEConfig {
  ...
  static const int totalEngineers = 4; // 1 AE + 3 JEs
  static const String department = 'Engineering Department - Zonal';
  static const String name = 'Dr. Suresh Patil';
  static const String employeeId = 'DE-Z1-001';
}
...
class _DeskViewState extends State<_DeskView> {
  List<Map<String, dynamic>> get newComplaints =>
      LegacyDashboardAdapter.deNewComplaints(_DEConfig.assignedWards);

  List<Map<String, dynamic>> get assignedComplaints =>
      LegacyDashboardAdapter.deAssignedComplaints(_DEConfig.assignedWards);
        ...
        Row(
          children: [
            ...
            Container(
              ...
              child: Text(
                '${_DEConfig.assignedWards.length} Wards',
                style: const TextStyle(
                  fontSize: 12,
...
// Deputy Engineer DESK CARD
class _DEDeskCard extends StatelessWidget {
  final Map<String, dynamic> data;
  final Function(LatLng, String) onLocationClick;
  final String cardType; // 'escalated', 'critical', 'pending'
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // SLA INDICATOR (for escalated and critical complaints)
            if (showSLAIndicator) ...[
              Container(
                padding: const EdgeInsets.symmetric(
                  horizontal: 10,
            ...
            // ASSIGNED INFO (for long pending view)
...
// Deputy Engineer COMPLAINT DETAIL SCREEN
      ...
      child: Column(
        ...
        children: [
          ...
          _sectionCard(
            ...
            children: [
              _infoRow('Department', _DEConfig.department),
              const Divider(height: 16),
              _infoRow('Designation', 'Deputy Engineer (Roads)'),
              const Divider(height: 16),
              _infoRow('Employee ID', _DEConfig.employeeId),
            ],
          ),
          const SizedBox(height: 16),
          ...
          _sectionCard(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: _DEConfig.assignedWards
                    .map(
                      (ward) => Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 12,
